...
public class Transition1Script : StateMachineBehaviour
{
    ...
    override public void OnStateUpdate(Animator animator, AnimatorStateInfo stateInfo, int layerIndex)
    {
        ...
        {
            AnguraController.Instance.animator.Play("Ground2");
        }

        if (AnguraController.Instance.isAirAttacking)
        {
            AnguraController.Instance.animator.Play("Air2");
        }
        //if (SamController.Instance.isAttacking)
        //{
        //    SamController.Instance.animator.Play("Light2");
        //}
    }
    ...
    {
        //AnguraController.Instance.cantMove = false;
        //SamController.Instance.isAttacking = false;
    }
